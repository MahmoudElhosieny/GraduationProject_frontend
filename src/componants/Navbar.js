      ...
      <nav className="navbar navbar-expand bg-light">
        <div className="container-fluid">
          <div className="collapse navbar-collapse" id="navbarNav">
              ...
              <li className="nav-item itemlist ms-4" onClick={()=>displayFun2()}>
                {props.Bed }
              </li>
              <li className="nav-item itemlist ms-4" onClick={()=>displayFun3()}>
                {props.Dining }
              </li>
              <li className="nav-item itemlist ms-4" onClick={()=>displayFun4()}>
                {props.Gard }
              </li>
